    ...
    <>
      <div className='mx-auto max-w-7xl px-6 pb-2 sm:pt-14 lg:px-8 lg:pt-1'>
        <div className='app mt-10 flex justify-center items-center '>
          <h1 className="text-4xl font-extrabold text-center bg-gradient-to-r from-green-500 via-green-300 to-green-500 bg-clip-text text-transparent">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4">
          <div className="w-full p-4 space-y-8">
            ...
            <div className="w-full flex justify-center p-4">
              <div className="w-full md:w-3/4 lg:w-1/2 flex flex-col items-center border border-green-600 rounded-3xl bg-gradient-to-r from-green-600 to-purple-600 p-4">
                <QRCode
          ...
          <div className=''>
            ...
            <div className='w-full  p-4'>
              <h2 className='text-2xl font-extrabold text-center bg-gradient-to-r from-green-500 via-purple-500 to-green-500 bg-clip-text text-transparent'>Add Your Logo</h2>
              <div className='flex flex-col space-y-4'>
                <ImageUploadField
