    ...
    <>
      <div className='mx-auto max-w-7xl px-6 pb-2 sm:pt-14 lg:px-8 lg:pt-1'>
        <div className='app mt-10 flex justify-center items-center '>
          <h1 className="text-4xl font-extrabold text-center bg-gradient-to-r from-blue-500 via-sky-500 to-blue-500 bg-clip-text text-transparent">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4">
          <div className="w-full p-4 space-y-8">
            ...
            <div className="w-full flex justify-center p-4">
              <div className="w-full md:w-3/4 lg:w-1/2 flex flex-col items-center border border-blue-600 rounded-3xl bg-gradient-to-r from-blue-600 to-sky-600 p-4">
                <QRCode
                ...
                <Button
                  ...
                  className="mt-5 px-4 py-2  bg-blue-300 text-blue-700 font-semibold rounded-3xl  hover:bg-blue-400 "
                >
                  Download QR Code
                </Button>
              </div>
          ...
          <div className=''>
            ...
            <div className='w-full  p-4'>
              <h2 className='text-2xl font-extrabold text-center bg-gradient-to-r from-blue-500 via-sky-500 to-blue-500 bg-clip-text text-transparent'>Add Your Logo</h2>
              <div className='flex flex-col space-y-4'>
                <ImageUploadField
