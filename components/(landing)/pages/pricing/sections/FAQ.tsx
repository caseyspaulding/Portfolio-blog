            ...
            <div className="grid gap-8 lg:grid-cols-3">
                <div>
                    ...
                    <div className="mb-10">
                        ...
                        <p className="mb-4 text-gray-600 dark:text-gray-400">
                            You can use FlowBite for an unlimited amount of projects, whether it's a
                            personal website, a SaaS app, or a website for a client. As long as you
                            don't build a product that will directly compete with FlowBite either as
                    ...
                    <div className="mb-10">
                        ...
                        <p className="mb-4 text-gray-600 dark:text-gray-400">
                            ...
                            of FlowBite includes a minimal style guidelines, component variants, and
                    ...
                    <div className="mb-10">
                        ...
                        <p className="mb-4 text-gray-600 dark:text-gray-400">
                            Although both FlowBite and Tailwind UI are built for integration with
                            Tailwind CSS, the main difference is in the design, the pages, the extra
                            components and UI elements that FlowBite includes.
                        </p>
                        <p className="mb-4 text-gray-600 dark:text-gray-400">
                            Additionally, FlowBite is a project that is still in development, and
                ...
                <div>
                    ...
                    <div className="mb-10">
                        ...
                        <p className="mb-4 text-gray-600 dark:text-gray-400">
                            ...
                            would be considered as an alternative to FlowBite itself.
                        </p>
                        <p className="mb-4 text-gray-600 dark:text-gray-400">
                    ...
                    <div className="mb-10">
                        ...
                        <p className="mb-4 text-gray-600 dark:text-gray-400">
                            Absolutely! You can use this design kit to build any type of commercial
                            business, whether it's a SaaS, an e-commerce app, an application UI.
                        </p>
                        <p className="mb-4 text-gray-600 dark:text-gray-400">
                    ...
                    <div className="mb-10">
                        ...
                        <p className="mb-4 text-gray-600 dark:text-gray-400">
                            ...
                            invoice. After the purchase, you will get an email with the invoice.
                        </p>
                        <p className="mb-4 text-gray-600 dark:text-gray-400">
                            If you forgot to complete the information, or you didn't get the invoice
                            by email, feel free to{' '}
                            <a
                                href="#"
                                className="font-medium text-primary-600 underline hover:no-underline dark:text-primary-500"
                                target="_blank"
                ...
                <div>
                    <div className="mb-10">
                        ...
                        <p className="mb-4 text-gray-600 dark:text-gray-400">
                            ...
                            . We are already working on the integration and if you have a pre-order,
                            you will also get frequent updates about the progress.
                        </p>
                        <p className="mb-4 text-gray-600 dark:text-gray-400">
                    ...
                    <div className="mb-10">
                        <h3 className="mb-4 text-lg font-medium text-gray-900 dark:text-white">
                            Is it allowed to use the design assets, such as the fonts, icons, and
                            illustrations?
                        </h3>
                        <p className="mb-4 text-gray-600 dark:text-gray-400">
                    ...
                    <div className="mb-10">
                        ...
                        <p className="mb-4 text-gray-600 dark:text-gray-400">
                            ...
                            the invoice, and another one with the download files.
                        </p>
                        <p className="mb-4 text-gray-600 dark:text-gray-400">
                            Soon we will create a way that you will be able to access the download
                            files from the FlowBite dashboard from this website.
                        </p>
                    </div>
                    <div className="mb-10">
                        <h3 className="mb-4 text-lg font-medium text-gray-900 dark:text-white">
