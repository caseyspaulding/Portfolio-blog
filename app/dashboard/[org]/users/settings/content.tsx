...
import type { UserSettingsSocialAccount } from '@/types/user/settings';
...
const UserProfileCard: FC<Pick<UserSettingsPageData, 'userProfile'>> = function ({ userProfile }) {
    return (
        <Card>
...
const LanguageTimeCard: FC<Pick<UserSettingsPageData, 'languages' | 'timezones' | 'userSettings'>> =
    function ({ languages, timezones, userSettings }) {
...
const SocialAccountsCard: FC<Pick<UserSettingsPageData, 'userSettings'>> = function ({
    userSettings
}) {
...
const OtherAccountsCard: FC<Pick<UserSettingsPageData, 'userSettings'>> = function ({
    userSettings
}) {
...
const GeneralInformationCard: FC<Pick<UserSettingsPageData, 'userProfile'>> = function ({
    userProfile
}) {
    return (
        <Card>
                ...
                <div className="grid grid-cols-6 gap-6">
                    ...
                    <div className="col-span-6 grid grid-cols-1 gap-y-2 sm:col-span-3">
                        ...
                        <TextInput
                            id="country"
                            name="country"
                            placeholder={userProfile.location.split(', ')[2]}
                            required
                        />
                    </div>
                    <div className="col-span-6 grid grid-cols-1 gap-y-2 sm:col-span-3">
                        ...
                        <TextInput
                            id="city"
                            name="city"
                            placeholder={userProfile.location.split(', ')[0]}
                            required
                        />
                    </div>
                    <div className="col-span-6 grid grid-cols-1 gap-y-2 sm:col-span-3">
                        ...
                        <TextInput
                            id="address"
                            name="address"
                            placeholder={userProfile.address.split(', ')[0]}
                            required
                        />
                    </div>
                    <div className="col-span-6 grid grid-cols-1 gap-y-2 sm:col-span-3">
                    ...
                    <div className="col-span-6 grid grid-cols-1 gap-y-2 sm:col-span-3">
                        ...
                        <TextInput
                            id="role"
                            name="role"
                            placeholder={userProfile.position}
                            required
                        />
                    </div>
                    <div className="col-span-6 grid grid-cols-1 gap-y-2 sm:col-span-3">
                    ...
                    <div className="col-span-6 grid grid-cols-1 gap-y-2 sm:col-span-3">
                        ...
                        <TextInput
                            id="zip-code"
                            name="zip-code"
                            placeholder={userProfile.address.split(' ').pop()}
                            required
                        />
                    </div>
...
const SessionsCard: FC<Pick<UserSettingsPageData, 'userSettings'>> = function ({ userSettings }) {
    return (
        <Card>
            <div className="flow-root">
...
const AlertsNotificationsCard: FC<Pick<UserSettingsPageData, 'userSettings'>> = function ({
    userSettings
}) {
    const [isCompanyNews, setCompanyNews] = useState(userSettings.alertsNotifications.companyNews);
    const [isAccountActivity, setAccountActivity] = useState(
        userSettings.alertsNotifications.accountActivity
    );
    const [isMeetupsNearYou, setMeetupsNearYou] = useState(
        userSettings.alertsNotifications.meetups
    );
...
const EmailNotificationsCard: FC<Pick<UserSettingsPageData, 'userSettings'>> = function ({
    userSettings
}) {
    const [isRatingReminders, setRatingReminders] = useState(
        userSettings.emailNotifications.ratingReminders
    );
    const [isItemUpdateNotifications, setItemUpdateNotifications] = useState(
        userSettings.emailNotifications.itemUpdates
    );
    const [isItemCommentNotifications, setItemCommentNotifications] = useState(
        userSettings.emailNotifications.itemComments
    );
    const [isBuyerReviewNotifications, setBuyerReviewNotifications] = useState(
        userSettings.emailNotifications.buyerReviews
    );
