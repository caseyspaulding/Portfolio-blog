...
const UserProfile: FC<Pick<UserFeedPageData, 'userProfile'>> = function ({ userProfile }) {
    return (
...
const UserFeed: FC<UserFeedPageData> = function ({ userFeed, userProfile }) {
    return (
        <>
                ...
                <div>
                    ...
                    <ul className="divide-y divide-gray-200 dark:divide-gray-700">
                        {userProfile.experience.map(
                            ({ organization, position, location, logo }) => (
                                <li
                                    key={logo}
                                    className="flex items-center space-x-4 py-4 first-of-type:pt-0 last-of-type:pb-0"
                                >
