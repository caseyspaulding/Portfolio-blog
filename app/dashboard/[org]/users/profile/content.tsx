...
const UserProfilePageDataContent: FC<UserProfilePageData> = function ({ userProfile }) {
    return (
        <div className="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4">
            ...
            <div className="col-span-full xl:col-auto">
                <ProfileIntro userProfile={userProfile} softwareSkills={[]} />
                <Skills userProfile={userProfile} softwareSkills={[]} />
                <Hobbies userProfile={userProfile} softwareSkills={[]} />
            </div>
            <div className="col-span-2">
                <GeneralInformation userProfile={userProfile} softwareSkills={[]} />
                <SkillProficiencyProgressBars userProfile={userProfile} softwareSkills={[]} />
            </div>
        </div>
    );
};
...
const SkillProficiencyProgressBars: FC<UserProfilePageData> = function ({ userProfile }) {
    return (
        <div className="mb-4 rounded-lg bg-white p-4 shadow dark:bg-gray-800 sm:p-6 xl:p-8">
