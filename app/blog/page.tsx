...
export default function BlogList ()
{
    ...
    const fetchFilteredPosts = async ( category: string, difficulty: string ) =>
    {
        try
        {
            const response = await fetch( '/api/getFilteredBlogPosts', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify( { category, difficultyLevel: difficulty } ),
            } );
            ...
            {
                console.error( 'Client - Failed to fetch filtered posts:', data.error );
            }
        } catch ( error )
        {
